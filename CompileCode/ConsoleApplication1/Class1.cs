...
namespace CompileCode.Extractor
{
    class Class1
    {
        static void Main(string[] args)
        {
            string OutputPath = @"D:\test.xml";
            string pwd = Console.ReadLine();
            DeCryptAndCheck(OutputPath, pwd);
           
           
            Console.ReadKey();
        }
        public static void DeCryptAndCheck(string OutputPath, string InputPwd)
        {
